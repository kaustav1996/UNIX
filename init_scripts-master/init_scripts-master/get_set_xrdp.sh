...
#################################################
#
# Script name 	: get_set_xrdp.sh
# Description	: auto detects linux distro and install [desktop-env[xfce], xrdp, browser's (makes google-chrome to auto lauch on rdp login)] for in it. 
# Author 	: undefined
#
#################################################


#### CENTOS 7 setup function ------------------------------------------------------------

# Setup Function for Centos Linux 7
# This function will be execute when a this script is run under [ Centos Linux 7 ]
# The function is devided into multiple internal function each doing an specific job.
